...
if ( ! function_exists( 'bizlight_footer' ) ) :
    ...
    ****************************************** -->
        <footer id="colophon" class="evision-wrapper site-footer" role="contentinfo">
            ...
            ?>
            <div class="copyright">
                <a class="navbar-brand" href="<?php echo(get_home_url()); ?>" title="Broovera"><img style="max-width:115px; position: relative; bottom: 3px;" src="<?php echo(get_home_url());?>/wp-content/uploads/2017/10/logo_broovera-1.png"></a>
